#pragma once
/// ·ûºÅº¯Êý: in_step_range
/// 1:1 ¶ÔÓ¦ Rust core/symbol/functions/in_step_range.rs
...
namespace ospf::core {
    ...
    class InStepRangeFunction : public VariadicFunctionSymbol<V> {
    public:
        [[nodiscard]] const char* name() const noexcept override { return "in_step_range"; }
